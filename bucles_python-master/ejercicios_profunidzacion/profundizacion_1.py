...
print("esta la lista de temperaturas: ", temperaturas)

print("esta es la suma total de todas las temperaturas: ", suma_total)

print("esta es la cantidad de temperaturas: ", cantidad_temperaturas)

print("este es el promedio de las temperaturas: ", promedio)
