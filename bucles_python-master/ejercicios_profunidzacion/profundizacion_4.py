...
while True:
    print(" Hola ¿cual es la operacion que quieres realizar?")
    print("1- Suma")
    print("2- resta")
    print("3- multiplicacion")
    print("4- division")
    print("5- SALIR")
    operacion = int(input("ingresa el numero con la opcion que seas realizar: "))

    if operacion == 1 or operacion == 2 or operacion == 3 or operacion == 4:
        break
    elif operacion == 5:
        print("gracias por participar :D")
        break
        pass
    else:
