...
print("la lista de las temperaturas es: ", temperaturas)

print("la cantidad de temperaturas es: ", cantidad_temperaturas)

print("la suma de todas las temperaturas es: ", suma_total)
