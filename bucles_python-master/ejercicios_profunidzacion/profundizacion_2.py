...
print("la lista de notas del alumno son: ", notas)

print("la cantidad de examenes que el alumno asistio es: ", cantidad_examenes)

print("la cantidad de examenes que el alumno no estuvo presente es: ", cantidad_ausentes)
